...
public class PropertyBuilder {
	...
	protected StringBuilder addSecurityManager(StringBuilder jvmArguments) {
		return jvmArguments.append(" -Djava.security.manager=org.ngrinder.sm." + getSecurityManagerBySecurityLevel(securityLevel) + " ");
	}
	...
	private String getSecurityManagerBySecurityLevel(String securityLevel) {
		...
		if (securityLevel.equalsIgnoreCase(GRINDER_SECURITY_LEVEL_LIGHT)) {
			return "NGrinderLightSecurityManager";
		}
		return "NGrinderSecurityManager";
	}
